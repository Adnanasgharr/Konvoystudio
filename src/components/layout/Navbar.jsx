...
// 📂 Local project image references pointing to public/assets/services/
const DEFAULT_PREVIEW = {
  ...
  img: "/assets/services/capabilities.jpg",
};
  ...
  webdev: {
    ...
    links: [
      ...
      },
      {
        ...
        img: "/images/services/website-redesign-services.webp",
      },
      {
        title: "Website Maintenance",
        slug: "website-maintenance",
        desc: "Continuous optimization, performance auditing, system patches, and cloud server maintenance.",
        img: "/images/services/website-maintenance-services.jpeg",
      },
    ],
  },
  video: {
    ...
    links: [
      {
        ...
        img: "/assets/services/corporate-video.jpg",
      },
      {
        ...
        img: "/assets/services/event-video.jpg",
      },
      {
        ...
        img: "/assets/services/promo-videos.jpg",
      },
      {
  ...
  brand: {
    ...
    links: [
      ...
      },
      {
        ...
        img: "/assets/services/media-graphics.jpg",
      },
    ...
    links: [
      {
        ...
        img: "/assets/services/rag-systems.jpg",
      },
      {
        ...
        img: "/assets/services/voice-agents.jpg",
      },
      {
        ...
        img: "/assets/services/automation-pipelines.jpg",
      },
    ],
  },
};
...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    if (isMobileMenuOpen) {
      ...
      gsap.to(burgerLine1Ref.current, {
        y: 3,
        rotate: 45,
        duration: 0.4,
        ease: "power4.out",
      });
      gsap.to(burgerLine2Ref.current, {
        y: -3,
        rotate: -45,
        duration: 0.4,
        ease: "power4.out",
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      gsap
        ...
        .to(navRef.current, {
          // Optimized from 1160px down to 1020px for a cleaner, compact fit
          ...
          paddingLeft: window.matchMedia("(min-width: 768px)").matches
            ? "36px"
            : "20px",
          paddingRight: window.matchMedia("(min-width: 768px)").matches
            ? "14px"
            : "20px",
          marginTop: window.matchMedia("(min-width: 768px)").matches
            ? "20px"
            : "10px",
  ...
  return (
    <>
      ...
      <header
        className={`fixed top-0 left-0 z-[100] w-full pointer-events-none flex justify-center transition-all duration-600 ease-[cubic-bezier(0.16,1,0.3,1)] ${
          isVisible
      ...
      >
        <nav
          ref={navRef}
          className="relative pointer-events-auto flex items-center justify-between w-full max-w-full h-[95px] px-6 md:px-6 bg-transparent border border-transparent will-change-[max-width,padding,margin,height,background-color,border-color,border-radius,backdrop-filter]"
        >
          {/* BRAND LOGO ELEMENT */}
          <div className="flex items-center shrink-0 z-[110]">
            <a
              href="/"
              className="text-white text-xl uppercase font-old-school tracking-wider font-bold"
            >
          ...
          <ul className="hidden md:flex items-center gap-2 h-full">
            ...
            >
              <div className="relative inline-flex items-center py-2">
                ...
                <span
                  className={`font-old-school text-sm tracking-wide capitalize transition-colors duration-300 ${isDropdownOpen ? "text-[#c8f135]" : "text-neutral-300 group-hover:text-white"}`}
                >
                  Services
                </span>
                <span
                  className={`absolute bottom-2 left-0 right-0 h-[1.5px] bg-[#c8f135] scale-x-0 origin-right transition-transform duration-500 ease-out group-hover:scale-x-100 group-hover:origin-left ${isDropdownOpen ? "scale-x-100 origin-left" : ""}`}
                />
              </div>
            </li>

            {/* STRUCTURAL LINKS TRACK */}
              ...
              >
                <div className="relative inline-flex items-center py-2">
                  <a
                    ...
                    className="font-old-school text-sm tracking-wide capitalize text-neutral-300 transition-colors duration-300 group-hover:text-white"
                  >
                    {item}
                  </a>
          ...
          <div className="flex items-center gap-4 shrink-0 z-[110]">
            ...
            >
              <div className="w-5 h-[5px] flex flex-col justify-between items-center relative">
                <span
                  ref={burgerLine1Ref}
                  className="block w-full h-[1.5px] bg-white rounded-full will-change-transform"
                />
                <span
                  ref={burgerLine2Ref}
                  className="block w-full h-[1.5px] bg-white rounded-full will-change-transform"
            ...
            <div className="w-full bg-[#0b0c0d]/98 border border-neutral-800/80 rounded-[32px] p-7 shadow-[0_60px_120px_-30px_rgba(0,0,0,0.95)] backdrop-blur-2xl flex gap-8">
                ...
                <div className="flex flex-col gap-3">
                  <div className="w-full h-40 rounded-[14px] bg-neutral-950 overflow-hidden relative border border-neutral-800/60">
                    <img
                      ...
                      src={activeTabImg}
                      alt={activeTabTitle}
                      className="w-full h-full object-cover object-top filter brightness-[0.85] transition-all duration-500 scale-100 group-hover/portal:scale-105"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-neutral-950/40 via-transparent to-transparent" />
                  </div>
                  <div className="flex flex-col gap-1 mt-1">
                    <h5 className="text-white font-old-school text-base tracking-wide">
                      {activeTabTitle}
                    </h5>
                    <p className="text-xs text-neutral-400 font-light leading-relaxed min-h-[64px]">
                      {activeTabDesc}
                    </p>
                  </div>
                </div>
              ...
              <div className="flex-1 grid grid-cols-4 gap-x-6 gap-y-7 py-2 pr-2 overflow-visible">
                {Object.entries(SERVICE_DATA).map(([key, section]) => (
                  <div
                    key={key}
                    className="dropdown-col flex flex-col gap-3.5 opacity-0 transform translate-y-[12px]"
                  >
                    <div className="flex flex-col gap-0.5 border-b border-neutral-800/60 pb-2">
                      <h4 className="font-old-school text-[14px] tracking-wide text-white capitalize whitespace-nowrap">
                        {section.title}
                      </h4>
                    </div>
                      ...
                      {section.links.map((link, i) => (
                        ...
                        >
                          <span className="text-[12.5px] font-light text-neutral-400 group-hover/item:text-[#c8f135] transition-colors duration-200 flex items-center gap-2">
                            ...
                            <span className="transform transition-transform duration-300 ease-out group-hover/item:translate-x-1">
                              {link.title}
                            </span>
                          </span>
                        </a>
          ...
          <div className="flex flex-col w-full max-w-lg mx-auto">
            ...
            <div className="flex flex-col w-full">
              ...
              {[
                ...
                <div
                  key={idx}
                  className="mobile-link-container border-b border-neutral-800/60 overflow-hidden w-full"
                >
                  <a
                    href={item.href}
                    className="flex items-center justify-between w-full py-5 text-left text-[11vw] xs:text-4xl font-old-school tracking-tight text-neutral-400 hover:text-white transition-colors duration-300 relative group"
                  >
                    ...
                    <svg
                      className="w-5 h-5 text-neutral-600 opacity-0 -translate-x-4 transition-all duration-300 group-hover:opacity-100 group-hover:translate-x-0 group-hover:text-[#c8f135]"
                      fill="none"
                      stroke="currentColor"
                      strokeWidth="2.5"
                      viewBox="0 0 24 24"
          ...
          <div className="mobile-menu-footer w-full max-w-lg mx-auto flex flex-col sm:flex-row sm:items-center justify-between gap-6 pt-6 border-t border-neutral-900 opacity-0 will-change-transform">
            <div className="flex flex-col gap-1.5">
              ...
              <a
                ...
                className="text-sm font-medium text-neutral-300 hover:text-[#c8f135] transition-colors"
              >
                hello@konvoy.studio
              </a>
            </div>
